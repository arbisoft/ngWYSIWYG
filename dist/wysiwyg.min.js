        ...
        function (ngpUtils, NGP_EVENTS, $rootScope, $compile, $timeout, $q) {
            var linker = function (scope, $element, attrs, ctrl) {
                ...
                scope.fontsizes = [{key: 1, name: 'x-small'}, {key: 2, name: 'small'}, {
                    key: 3,
                    name: 'normal'
                }, {key: 4, name: 'large'}, {key: 5, name: 'x-large'}, {key: 6, name: 'xx-large'}, {
                    key: 7,
                    name: 'xxx-large'
                }];
    ...
    angular.module('ngWYSIWYG').directive('ngpContentFrame', ['ngpImageResizer', 'ngpUtils', 'NGP_EVENTS', '$compile',
        '$timeout', '$sanitize', function (ngpImageResizer, ngpUtils, NGP_EVENTS, $compile, $timeout, $sanitize) {
            ...
            var linker = function (scope, $element, attrs, ctrl) {
                ...
                $document.write('<!DOCTYPE html><html><head></head><body class="iframe-body" contenteditable="true"></body></html>');
                $document.close();
                ...
                $head.append('<style> ' +
                    'body{font-size:14px; line-height:17px; margin-left:14px; color:#555555; Font-family:"Quattrocento Sans", sans-serif;}' +
                    'body ul{ margin:0; }' +
                    'body ol{ margin:0; }' +
                    '</style>');
                $body.attr('contenteditable', 'true');
                //focusing iframe element (Maryam and Raza)
                $element[0].focus();
